class Validator {
  ...
  redirectToAnotherPage() {
    let registerButton = document.getElementById("btn-submit"); // Supondo que o botão de "Registrar" tem o ID "btn-submit"

    registerButton.addEventListener('click', function(e) {
      e.preventDefault();
      let form = document.getElementById("register-form"); // Supondo que o formulário tem o ID "register-form"
      let validator = new Validator();
      validator.validate(form);
      window.location.href = "/Tela_Principal/Principal.html"; // Substitua com a página desejada para o redirecionamento
    });
  }
...
let validator = new Validator();
validator.redirectToAnotherPage();
